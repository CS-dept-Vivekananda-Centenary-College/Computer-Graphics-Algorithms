    ...
    glPushMatrix();
        ...
        glRotatef(45,0,0.0,0.0);
            glBegin(GL_POLYGON);
                ...
                glVertex3f(1, 5.0, 0.0f);

                glColor3f(0.0f, 0.0f, 1.0);
                glVertex3f(2.0, 10.0, 0.0f);

                glColor3f(0.0f, 1.0, 0.0);
                glVertex3f(5.0, 10.0, 0.0f);

                glColor3f(0.0f, 1.0, 1.0);
                glVertex3f(6.0, 5.0, 0.0f);

                glColor3f(1.0, 0.0f, 0.0f);
                glVertex3f(5.0, 0.0, 0.0f);
...
/**
    g++ hexagon.cpp -o hexagon -lglut -lGLU -lGL
    ./hexagon
*/